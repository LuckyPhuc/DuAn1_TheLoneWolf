                    ...
                    <div class="row">
                        <div class="col-lg-12 col-custom">
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-8 col-xl-6 position-static d-none d-lg-block col-custom">
                                ...
                                <div
                                    class="col-lg-1 col-xl-4 col-sm-6 col-6 col-custom login_resgister d-flex justify-content-end">
                                    <div class="login-register-wrap d-none d-xl-flex ">
                                        @auth
                                            @include('layouts.navigation')
                                        @else
                                            <div class="header-right-area main-nav px-4">
                                                <a href="{{ route('login') }}"
                                                    class="font-semibold text-gray-600 hover:#e98c81 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Đăng
                                                    nhập</a>

                                                @if (Route::has('register'))
                                                    <a href="{{ route('register') }}"
                                                        class="ml-4 font-semibold text-gray-600 hover:#e98c81 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Đăng
                                                        ký</a>
                                                @endif
                                            </div>
                                        @endauth
