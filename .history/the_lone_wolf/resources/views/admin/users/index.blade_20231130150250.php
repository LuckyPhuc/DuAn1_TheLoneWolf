                        ...
                        <table class="table  datanew">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="productimgname">
                                        <a href="javascript:void(0);" class="product-img">
                                            <img src="{{asset('assets/img/customer/customer2.jpg')}}" alt="img">
                                        </a>
                                    </td>
                                    <td>Benjamin</td>
                                    <td>Franklin </td>
                                ...
                                <tr>
                                    ...
                                    <td class="productimgname">
                                        <a href="javascript:void(0);" class="product-img">
                                            <img src="{{asset('assets/img/customer/customer3.jpg')}}" alt="img">
                                        </a>
                                    </td>
                                    <td>James</td>
                                    <td>James </td>
                                ...
                                <tr>
                                    ...
                                    <td class="productimgname">
                                        <a href="javascript:void(0);" class="product-img">
                                            <img src="{{asset('assets/img/customer/customer4.jpg')}}" alt="img">
                                        </a>
                                    </td>
                                    <td>Bruklin</td>
                                    <td>Bruklin </td>
                                ...
                                <tr>
                                    ...
                                    <td class="productimgname">
                                        <a href="javascript:void(0);" class="product-img">
                                            <img src="{{asset('assets/img/customer/customer6.jpg')}}" alt="img">
                                        </a>
                                    </td>
                                    <td>B. Huber </td>
                                    <td>Jacob </td>
                                ...
                                <tr>
                                    ...
                                    <td class="productimgname">
                                        <a href="javascript:void(0);" class="product-img">
                                            <img src="assets/img/customer/customer7.jpg" alt="product">z <img src="{{asset('assets/img/customer/customer1.jpg')}}" alt="img">
                                        </a>
                                    </td>
                                    <td>Alwin</td>
                                    <td>Alwin </td>
